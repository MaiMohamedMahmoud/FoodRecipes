...
public class FatSecretSearchFoodRetrofit extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private List<Recipe_> recipesListFav;
    ...
    protected void onResume() {
        ...
        Type type = new TypeToken<List<Recipe_>>() {
        }.getType();
        if (json == "") {
            recipesListFav = new ArrayList<>();
        } else {
    ...
    private void loadRecyclerViewData() {
        ...
        if (current_page_number < page_numbers) {
            Toast.makeText(getApplicationContext(), "current page " + current_page_number, Toast.LENGTH_LONG).show();
                ...
                if (recipesDetailsObj != null) {
                    ...
                    if (jsonElementRecipes != null) {
                        ...
                        if (jsonElementRecipes.isJsonObject()) {
                            JsonObject mJsonObject = jsonElementRecipes.getAsJsonObject();
                            Recipe_ obj_recipe = new Recipe_();

                            obj_recipe.setRecipeDescription(mJsonObject.get("recipe_description").getAsString());
                            obj_recipe.setRecipeId(mJsonObject.get("recipe_id").getAsLong());
                            if (mJsonObject.get("recipe_image") != null) {
                                obj_recipe.setRecipeImage(mJsonObject.get("recipe_image").getAsString());
                            } else {
                            ...
                            obj_recipe.setRecipeUrl(mJsonObject.get("recipe_url").getAsString());
                            recipesList.add(obj_recipe);
                        } else if (jsonElementRecipes.isJsonArray()) {
                            JsonArray mJsonArray = jsonElementRecipes.getAsJsonArray();
...
//            }
    ...
    private class RecipeHolder extends RecyclerView.ViewHolder {
        ...
        public void Bind(final Recipe_ mRecipe) {
            Log.i("Image", mRecipe.getRecipeImage());
            Log.i("recipeCheck Bind", mRecipe.getRecipeId() + "");
            recipeDescription.setText(mRecipe.getRecipeDescription());
            recipeName.setText(mRecipe.getRecipeName() + " ");
            //To animate the favourite button.
            scaleAnimation = new ScaleAnimation(0.7f, 1.0f, 0.7f, 1.0f, Animation.RELATIVE_TO_SELF, 0.7f, Animation.RELATIVE_TO_SELF, 0.7f);
            scaleAnimation.setDuration(500);
            bounceInterpolator = new BounceInterpolator();
            scaleAnimation.setInterpolator(bounceInterpolator);
            buttonFavorite.setChecked(false);
            checkFavourite(mRecipe);
            ...
            buttonFavorite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (buttonFavorite.isChecked()) {
                        ...
                        Toast.makeText(getApplicationContext(), "is not checked", Toast.LENGTH_LONG).show();
...
//                    //to store the object in sharedpref.
//                    if (isChecked) {
//                        } else {
////                        buttonFavorite.setChecked(false);
//                        for (int i = 0; i < recipesListFav.size(); i++) {
...
//            });
            ...
            if (mRecipe.getRecipeImage() != "") {
                Toast.makeText(getApplicationContext(),"Ana 3ndy image",Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(getApplicationContext(),"no image",Toast.LENGTH_LONG).show();
                Picasso.with(FatSecretSearchFoodRetrofit.this).
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("recipeId", mRecipe.getRecipeId());
        ...
        public void checkFavourite(Recipe_ recipe) {
            Log.i("recipeCheck 1", recipe.getRecipeId() + "");
            for (int i = 0; i < recipesListFav.size(); i++) {
                Log.i("recipeCheck ", "i " + i + " .." + recipesListFav.get(i).getRecipeId() + "");
                if (recipesListFav.get(i).getRecipeId() == recipe.getRecipeId()) {
                    Log.i("recipeCheck ", "ana checked my id is " + recipesListFav.get(i).getRecipeId() + " el id bta3 el recipe " + recipe.getRecipeId());
